...
This means the decisions are ready to become a local specification at
`.scratch/<feature-slug>/spec.md`. It does not mean implementation tickets
already exist; `to-tickets` creates those as separate implementation units.
