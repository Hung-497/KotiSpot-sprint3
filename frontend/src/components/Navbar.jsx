            ...
            {isMenuOpen && (
              <div className="absolute right-0 top-14 z-50 w-105 rounded-3xl border border-gray-200 bg-white p-5 shadow-[0_15px_40px_rgba(15,35,55,0.15)]">
                ...
                <div className="relative z-10 mb-5 flex items-center gap-4 rounded-2xl bg-[#f1f7f4] px-5 py-5">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold capitalize text-[#08243f]">
                ...
                <div className="space-y-1">
                  ...
                  {canApply && (
                    <Link
                      to="/applicationform"
                      onClick={() => setIsMenuOpen(false)}
                      className="flex items-start gap-4 rounded-xl px-4 py-3 text-sm text-[#08243f] transition hover:bg-[#eef6f2] hover:text-[#17634f]"
                    >
                      <BriefcaseBusiness
                        size={20}
                        strokeWidth={1.8}
